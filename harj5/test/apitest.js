...
describe('Testing Server API', () => {
    ...
    it('it should post a student from /students', (done) => {
        ...
        */
        let apiteststudent = {
            /* eslint quotes: "off" */
            "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVjOTlmYjk3ZTNlMjYwNDE1ZWQwYTA4NCIsImlhdCI6MTU1MzU5NTI5OSwiZXhwIjoxNTUzNjgxNjk5fQ.FDzIsD1Pjs07JXivRR5Or-m0ULA17XPBsH6y5r32LLc",
            "student_code": "a1234",
